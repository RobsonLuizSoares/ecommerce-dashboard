...
class DetalhesDaEntrega extends Component {
    ...
    handleSubmit = (value) => {
        if (!value) return this.setState({ aviso: { status: false, msg: 'Preencha o código de rastreamento para enviar um novo status' } })
        this.setNovoStatus('Atualização no Código de Rastreamento', value)
    }
    render() {
